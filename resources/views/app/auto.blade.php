        ...
        <div class="col-sm-8">
            <div class="ibox">
                <div class="ibox-content">
                    <h2>Транспортные средства
                        <a data-toggle="tab" href="#edit" v-on:click="New()"  class="btn btn-primary btn-xs" style="float: right;">ДОБАВИТЬ</a>
                        <a href="/print/autos"  class="btn btn-primary btn-xs" style="float: right;margin-right: 10px;">ПЕЧАТЬ</a>
                    </h2>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tr v-for="var in autos">
                                                ...
                                                <td>@{{ var.date_rem}}</td>
                                                <td>@{{ var.rem_kil}}</td>
                                                <td v-if="var.devise_bool">ЕСТЬ</td>
                                                <td v-if="!var.devise_bool">НЕТ</td>
                        ...
                        <div id="edit" class="tab-pane active">
                            <div class="row m-b-lg">
                                <div class="col-lg-12 text-center">
                                    <h2>@{{ edit.title }}
                                        <a v-if="edit.action =='update'" href="/print/auto/@{{ edit.id }}"  class="btn btn-primary btn-xs" style="float: right;margin-right: 10px;">ПЕЧАТЬ</a>
                                    </h2>
                                </div>
                            </div>
                            <div class="client-detail">
                                <div class="full-height-scroll">
                                    <div class="project-list">
                                        ...
                                        <div class="form-group">
                                            <label>Номер</label>
                                            <input type="text" v-model="edit.number" class="form-control">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Ремонт километров</label>
                                            <input type="text" v-model="edit.rem_kil" class="form-control">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label>Прицепное средство</label>
                                            <select class="form-control" v-model="edit.devise_bool">
            ...
            new Vue({
                ...
                methods: {
                    ...
                    fetchItems: function (page) {
                        var data = {page: page};
                        this.$http.get('/autoApi/?page=' + page).then(function (response) {
                            //look into the routes file and format your response
                            this.$set('autos', response.data.autos);
                    ...
                    Delete: function (id) {
                        x = window.confirm("Вы хотите удалить ТС?");
                        if (x) {
                            this.$http.post('/autoApi/delete/'+id).then(function(response) {
                                this.fetchItems(this.pagination.current_page);
                            });
                        }
                    },
                    Edit: function (id) {
                        this.edit={};
                        this.edit = this.autos[id];
                        this.edit.title = 'Редактировать';
                        this.edit.action ='update';
                    },
                    New: function (id) {
                        this.edit={};
                        this.edit.title = 'Добавить ТС';
                        this.edit.action ='add';
                    },
                    SaveData: function(){
                        this.edit.user_id = '{{Auth::user()->id}}';
                        this.$http.post('/autoApi/edit', this.edit).then(function (response) {
                            this.fetchItems(this.pagination.current_page);
                        });
                    }
                }
