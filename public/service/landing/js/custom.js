(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('#intro').backstretch([
            'service/landing/images/bg1.jpg',
            'service/landing/images/bg2.jpg',
            'service/landing/images/bg3.jpg'
        ...
        var image = new google.maps.MarkerImage('service/landing/images/map-icon.png',
        ...
        map.addMarker({
            ...
            title: 'Exyplis',
            infoWindow: {
                content: '<p><strong>Exyplis</strong><br/> We are here</p>'
            }
        });
