...
!function (a) {
    ...
    function d(a, b) {
        var c = a.getAttribute("type"), d = "INPUT" === a.tagName && -1 !== b.supportsInputType.indexOf(c) || a.isContentEditable || "TEXTAREA" === a.tagName;
        if (!d) {
            var e = document.createElement("input");
            e.setAttribute("type", c), d = "text" === e.type, e = null
        }
        return d
    }
    ...
    function h(e, f, g) {
        function i(a, b, c) {
            ...
            do {
                if (a === !0 && p().validPositions[i]) {
                    ...
                    e = k.match, d = k.locator.slice(), h.push(c === !0 ? k.input : L(i, e))
                } else f = u(i, d, i - 1), e = f.match, d = f.locator.slice(), (g.jitMasking === !1 || j > i || isFinite(g.jitMasking) && g.jitMasking > i) && h.push(L(i, e));
                i++
        ...
        function r(a, b) {
            var c = p(), d = -1, e = c.validPositions;
            void 0 === a && (a = -1);
            var f = d, g = d;
            for (var h in e) {
                var i = parseInt(h);
        ...
        function s(b, c, d) {
            if (g.insertMode && void 0 !== p().validPositions[b] && void 0 === d) {
                var e, f = a.extend(!0, {}, p().validPositions), h = r();
        ...
        function y(b, c, d, e) {
            function f(c, d, e, h) {
                function j(e, h, m) {
                    ...
                    if (i > 1e4)throw"Inputmask: There is probably an error in your mask definition or in the code. Create an issue on github with an example of the mask you are using. " + p().mask;
                    if (i === b && void 0 === e.matches)return k.push({match: e, locator: h.reverse()}), !0;
                    if (void 0 !== e.matches) {
                        if (e.isGroup && m !== e) {
                            if (e = j(c.matches[a.inArray(e, c.matches) + 1], h))return !0
                        } else if (e.isOptional) {
                            var q = e;
                            if (e = f(e, d, h, m)) {
                                if (g = k[k.length - 1].match, !n(g, q))return !0;
                                l = !0, i = b
                            }
                        } else if (e.isAlternator) {
                            var r, s = e, t = [], u = k.slice(), v = h.length, w = d.length > 0 ? d.shift() : -1;
                            if (-1 === w || "string" == typeof w) {
                                var y, z = i, A = d.slice(), B = [];
                                ...
                                })), k = u.concat(t), i = b, l = k.length > 0
                            } else e = j(s.matches[w] || c.matches[w], [w].concat(h), m);
                            if (e)return !0
                        } else if (e.isQuantifier && m !== c.matches[a.inArray(e, c.matches) - 1])for (var J = e, K = d.length > 0 ? d.shift() : 0; K < (isNaN(J.quantifier.max) ? K + 1 : J.quantifier.max) && b >= i; K++) {
            ...
            var g, h = p().maskToken, i = c ? d : 0, j = c || [0], k = [], l = !1;
            if (b > -1) {
                if (e === !0 && p().tests[b])return p().tests[b];
                if (void 0 === c) {
                    for (var m, n = b - 1; void 0 === (m = p().validPositions[n]) && n > -1 && (!p().tests[n] || void 0 === (m = p().tests[n][0]));)n--;
        ...
        function E(b, c, d, e) {
            function f(b, c, d, e) {
                ...
                return a.each(y(b), function (h, i) {
                    ...
                    if (c && (l += c), A(!0), f = null != j.fn ? j.fn.test(l, p(), b, d, g) : c !== j.def && c !== g.skipOptionalPartCharacter || "" === j.def ? !1 : {
                        ...
                        return f !== !0 && void 0 === f.pos && void 0 === f.c ? !1 : (h > 0 && q(!0), s(o, a.extend({}, i, {input: C(n, j)}), e) || (f = !1), !1)
                    }
                }), f
            }
            ...
            function i(b, c) {
                for (var d = p().validPositions[c], e = d.locator, f = e.length, g = b; c > g; g++)if (void 0 === p().validPositions[g] && !F(g, !0)) {
                    var h = y(g), i = h[0], j = -1;
            ...
            if (l < G() && (m = f(l, c, d, e), (!d || e) && m === !1)) {
                ...
                if (!o || null !== o.match.fn || o.match.def !== c && c !== g.skipOptionalPartCharacter) {
                    if ((g.insertMode || void 0 === p().validPositions[H(l)]) && !F(l, !0)) {
                        var v = u(l).match, v = v.placeholder || v.def;
                        f(l, v, d, e);
                        for (var w = l + 1, z = H(l); z >= w; w++)if (m = f(w, c, d, e), m !== !1) {
                            i(l, w), l = w;
                            break
                        }
                    }
            ...
            if (m === !1 && g.keepStatic && (m = h(b, c, d, e)), m === !0 && (m = {pos: l}), a.isFunction(g.postValidation) && m !== !1 && !d) {
                var I = g.postValidation(A(!0), g);
                if (I) {
                    if (I.refreshFromBuffer) {
                        var K = I.refreshFromBuffer;
                        B(K === !0 ? K : K.start, K.end, I.buffer), q(!0), m = I
                    }
        ...
        function F(a, b) {
            var c;
            if (b ? (c = u(a).match, "" == c.def && (c = v(a))) : c = v(a), null != c.fn)return c.fn;
        ...
        function G() {
            var a;
            pa = void 0 !== na ? na.maxLength : void 0, -1 === pa && (pa = void 0);
        ...
        function K(b, c, d, e, f) {
            ...
            b.inputmask._valueSet(c.join("")), void 0 === d || void 0 !== e && "blur" === e.type || O(b, d), f === !0 && (ta = !0, a(b).trigger("input"))
        }
        ...
        function M(c, d, e, f) {
            function h() {
                var a = !1, b = z().slice(k, H(k)).join("").indexOf(j);
                if (-1 !== b && !F(k)) {
                    a = !0;
            ...
            if (q(), p().p = H(-1), !e)if (g.autoUnmask !== !0) {
                var l = z().slice(0, H(-1)).join(""), m = i.join("").match(new RegExp("^" + b.escapeRegex(l), "g"));
        ...
        function P(b) {
            var c, d, e = A(), f = e.length, g = r(), h = {}, i = p().validPositions[g], j = void 0 !== i ? i.locator.slice() : void 0;
        ...
        function V(d) {
            var e = this, f = a(e), h = d.keyCode, i = O(e);
            ...
            }, 0)) : (g.insertMode = !g.insertMode, O(e, g.insertMode || i.begin !== G() ? i.begin : i.begin - 1)), g.onKeyDown.call(this, d, A(), O(e).begin, g), ua = -1 !== a.inArray(h, g.ignorables)
        }

        function W(c, d, e, f, h) {
            var i = this, j = a(i), k = c.which || c.charCode || c.keyCode;
            if (!(d === !0 || c.ctrlKey && c.altKey) && (c.ctrlKey || c.metaKey || ua))return k === b.keyCode.ENTER && la !== A().join("") && (la = A().join(""), setTimeout(function () {
                j.trigger("change")
            }, 0)), !0;
            if (k) {
                46 === k && c.shiftKey === !1 && "," === g.radixPoint && (k = 44);
                var l, m = d ? {begin: h, end: h} : O(i), n = String.fromCharCode(k), o = S(m.begin, m.end);
                ...
                var r = ra && !o ? m.end : m.begin, t = E(r, n, f);
                if (t !== !1) {
        ...
        function X(b) {
            var c = this, d = b.originalEvent || b, e = a(c), f = c.inputmask._valueGet(!0), h = O(c);
            if ("propertychange" === b.type && c.inputmask._valueGet().length <= G())return !0;
            if ("paste" === b.type) {
                var i = f.substr(0, h.begin), j = f.substr(h.end, f.length);
        ...
        function Z(a) {
            var c = this, d = O(c), e = c.inputmask._valueGet();
            e = e.replace(new RegExp("(" + b.escapeRegex(z().join("")) + ")*"), ""), d.begin > e.length && (O(c, e.length), d = O(c)), A().length - e.length !== 1 || e.charAt(d.begin) === A()[d.begin] || e.charAt(d.begin + 1) === A()[d.begin] || F(d.begin) ? Y.call(this, a) : (a.keyCode = g.keyCode.BACKSPACE, V.call(c, a)), a.preventDefault()
        }

        function $(a) {
            var b = a.originalEvent || a;
            la = A().join(""), "" === ma || 0 !== b.data.indexOf(ma)
        }

        function _(b) {
            var c = this, d = b.originalEvent || b;
            0 === d.data.indexOf(ma) && (q(), p().p = H(-1), ta = !0);
            for (var e = d.data, f = 0; f < e.length; f++) {
                var h = new a.Event("keypress");
                h.which = e.charCodeAt(f), sa = !1, ua = !1, W.call(c, h, !0, !1, !1, p().p)
            }
            setTimeout(function () {
                var a = p().p;
        ...
        function ba(b) {
            var c = this, d = c.inputmask._valueGet();
            M(c, !0, !1, (a.isFunction(g.onBeforeMask) ? g.onBeforeMask(d, g) || d : d).split("")), la = A().join(""), (g.clearMaskOnLostFocus || g.clearIncomplete) && c.inputmask._valueGet() === z().join("") && c.inputmask._valueSet("")
        }

        function ca(a) {
            var b = this, c = b.inputmask._valueGet();
            g.showMaskOnFocus && (!g.showMaskOnHover || g.showMaskOnHover && "" === c) ? b.inputmask._valueGet() !== A().join("") && K(b, A(), H(r())) : va === !1 && O(b, H(r())), g.positionCaretOnTab === !0 && setTimeout(function () {
                O(b, H(r()))
            }, 0), la = A().join("")
        }
        ...
        function da(a) {
            ...
            if (va = !1, g.clearMaskOnLostFocus) {
                var c = A().slice(), d = b.inputmask._valueGet();
        ...
        function ea(b) {
            ...
            if (document.activeElement === d) {
                var e = O(d);
                if (e.begin === e.end)if (c(e.begin))O(d, g.numericInput ? H(a.inArray(g.radixPoint, A())) : a.inArray(g.radixPoint, A())); else {
                    var f = e.begin, h = r(f), i = H(h);
        ...
        function ga(c) {
            var d = this, e = a(d), f = O(d), h = c.originalEvent || c, i = window.clipboardData || h.clipboardData, j = ra ? A().slice(f.end, f.begin) : A().slice(f.begin, f.end);
            i.setData("text", ra ? j.reverse().join("") : j.join("")), document.execCommand && document.execCommand("copy"), U(d, b.keyCode.DELETE, f), K(d, A(), p().p, c, la !== A().join("")), d.inputmask._valueGet() === z().join("") && e.trigger("cleared"), g.showTooltip && (d.title = g.tooltip || p().mask)
        }

        function ha(b) {
            var c = a(this), d = this;
            if (d.inputmask) {
                var e = d.inputmask._valueGet(), f = A().slice();
                la !== f.join("") && setTimeout(function () {
                    c.trigger("change"), la = f.join("")
        ...
        function ia(a) {
            var b = this;
            va = !0, document.activeElement !== b && g.showMaskOnHover && b.inputmask._valueGet() !== A().join("") && K(b, A())
        }

        function ja(a) {
            la !== A().join("") && oa.trigger("change"), g.clearMaskOnLostFocus && -1 === r() && na.inputmask._valueGet && na.inputmask._valueGet() === z().join("") && na.inputmask._valueSet(""), g.removeMaskOnSubmit && (na.inputmask._valueSet(na.inputmask.unmaskedvalue(), !0), setTimeout(function () {
                K(na, A())
            }, 0))
        }
        ...
        function ka(b) {
            if (na = b, oa = a(na), g.showTooltip && (na.title = g.tooltip || p().mask), ("rtl" === na.dir || g.rightAlign) && (na.style.textAlign = "right"), ("rtl" === na.dir || g.numericInput) && (na.dir = "ltr", na.removeAttribute("dir"), na.inputmask.isRTL = !0, ra = !0), wa.off(na), T(na), d(na, g) && (wa.on(na, "submit", ja), wa.on(na, "reset", ja), wa.on(na, "mouseenter", ia), wa.on(na, "blur", ha), wa.on(na, "focus", ca), wa.on(na, "mouseleave", da), wa.on(na, "click", ea), wa.on(na, "dblclick", fa), wa.on(na, o, X), wa.on(na, "dragdrop", X), wa.on(na, "drop", X), wa.on(na, "cut", ga), wa.on(na, "complete", g.oncomplete), wa.on(na, "incomplete", g.onincomplete), wa.on(na, "cleared", g.oncleared), wa.on(na, "keydown", V), wa.on(na, "keypress", W), m || (wa.on(na, "compositionstart", $), wa.on(na, "compositionupdate", _), wa.on(na, "compositionend", aa)), "paste" === o && wa.on(na, "input", Y), (k || m || l || n) && (wa.off(na, "input"), wa.on(na, "input", Z))), wa.on(na, "setvalue", ba), "" !== na.inputmask._valueGet() || g.clearMaskOnLostFocus === !1) {
                ...
                M(na, !0, !1, c.split(""));
                var e = A().slice();
                la = e.join(""), R(e) === !1 && g.clearIncomplete && q(), g.clearMaskOnLostFocus && (e.join("") === z().join("") ? e = [] : Q(e)), K(na, e), document.activeElement === na && O(na, H(r()))
            }
        }

        var la, ma, na, oa, pa, qa, ra = !1, sa = !1, ta = !1, ua = !1, va = !0, wa = {
            on: function (c, d, e) {
                var f = function (c) {
                    var d = !1, f = !1;
                    if (void 0 === this.inputmask) {
                        ...
                        if ("setvalue" === c.type || !(this.disabled || this.readOnly && !("keydown" === c.type && c.ctrlKey && 67 === c.keyCode || g.tabThrough === !1 && c.keyCode === b.keyCode.TAB))) {
                            switch (c.type) {
                                case"input":
                                    if (ta === !0 || d === !0)return ta = !1, c.preventDefault();
                                    f = !1;
                                    break;
                                case"keydown":
                                    sa = !1, d = !1, f = !0;
                                    break;
                                case"keypress":
                                    if (sa === !0)return c.preventDefault();
                                    sa = !0;
                                    break;
                ...
                c.inputmask.events[d] = c.inputmask.events[d] || [], c.inputmask.events[d].push(f), -1 != ["submit", "reset"].indexOf(d) ? null != c.form && a(c.form).on(d, f) : a(c).on(d, f)
            }, off: function (b, c) {
        ...
        if (void 0 !== e)switch (e.action) {
            ...
            case"mask":
                na = e.el, f = na.inputmask.maskset, g = na.inputmask.opts, ra = na.inputmask.isRTL, la = A().join(""), ka(na);
                break;
            case"format":
            ...
            case"isValid":
                g.numericInput && (ra = !0), e.value ? (qa = e.value.split(""), M(void 0, !1, !0, ra ? qa.reverse() : qa)) : e.value = A().join("");
                for (var xa = A(), ya = P(), za = xa.length - 1; za > ya && !F(za); za--);
                return xa.splice(ya, za + 1 - ya), R(xa) && e.value === A().join("");
            case"getemptymask":
                return z();
            case"remove":
                na = e.el, oa = a(na), f = na.inputmask.maskset, g = na.inputmask.opts, na.inputmask._valueSet(N(na)), wa.off(na);
                var Aa;
                Object.getOwnPropertyDescriptor && (Aa = Object.getOwnPropertyDescriptor(na, "value")), Aa && Aa.get ? na.inputmask.__valueGet && Object.defineProperty(na, "value", {
                    get: na.inputmask.__valueGet,
                    set: na.inputmask.__valueSet
                }) : document.__lookupGetter__ && na.__lookupGetter__("value") && na.inputmask.__valueGet && (na.__defineGetter__("value", na.inputmask.__valueGet), na.__defineSetter__("value", na.inputmask.__valueSet)), na.inputmask = void 0;
                break;
            case"getmetadata":
                if (a.isArray(f.metadata)) {
                    for (var Ba, Ca = r(), Da = Ca; Da >= 0; Da--)if (p().validPositions[Da] && void 0 !== p().validPositions[Da].alternation) {
    ...
    return b.extendAliases({
        numeric2: {
            mask: function (a) {
                ...
                0 !== a.repeat && isNaN(a.integerDigits) && (a.integerDigits = a.repeat), a.repeat = 0, a.groupSeparator === a.radixPoint && ("." === a.radixPoint ? a.groupSeparator = "," : "," === a.radixPoint ? a.groupSeparator = "." : a.groupSeparator = ""), " " === a.groupSeparator && (a.skipOptionalPartCharacter = void 0), a.autoGroup = a.autoGroup && "" !== a.groupSeparator;
                var c = "+", d = 0;
                a.autoGroup && ("string" == typeof a.groupSize && isFinite(a.groupSize) && (a.groupSize = parseInt(a.groupSize)), isFinite(a.integerDigits) && (c = Math.floor(a.integerDigits / a.groupSize), d = a.integerDigits % a.groupSize)), a.placeholder.length > 1 && (a.placeholder = a.placeholder.charAt(0)), a.jitMasking === !0 && a.placeholder.length > 0 && (a.jitMasking = 1), a.radixFocus = a.radixFocus && "" !== a.placeholder && a.integerOptional === !0, a.definitions[";"] = a.definitions["~"], a.definitions[";"].definitionSymbol = "~";
                var e = b(a.prefix);
                return e += "[+]", a.autoGroup ? (e += "(" + a.groupSeparator + "~{" + a.groupSize + "}){" + c + "}", d > 0 && (e += "~{" + d + "}")) : e += "~{" + a.integerDigits + "}", void 0 !== a.digits && (isNaN(a.digits) || parseInt(a.digits) > 0) && (a.digitsOptional ? e += "[" + (a.decimalProtect ? ":" : a.radixPoint) + ";{1," + a.digits + "}]" : (e += (a.decimalProtect ? ":" : a.radixPoint) + ";{" + a.digits + "}", isFinite(a.jitMasking) && a.jitMasking < 1 + a.radixPoint.length + (isFinite(a.digits) ? a.digits : 2) && (a.jitMasking = 1 + a.radixPoint.length + (isFinite(a.digits) ? a.digits : 2)))), "" !== a.negationSymbol.back && (e += "[-]"), e += b(a.suffix), a.greedy = !1, e
            },
            placeholder: "",
            greedy: !1,
            digits: "*",
            ...
            onBeforeWrite: function (c, d, e, f) {
                if (c && ("blur" === c.type || "checkval" === c.type)) {
                    ...
                    if (h = h.replace(f.suffix, ""), h = h.replace(new RegExp(b.escapeRegex(f.groupSeparator), "g"), ""), "," === f.radixPoint && (h = h.replace(b.escapeRegex(f.radixPoint), ".")), isFinite(h) && isFinite(f.min) && parseFloat(h) < parseFloat(f.min))return {
                        refreshFromBuffer: !0,
            ...
            radixHandler: function (b, c, d, e, f) {
                if (!e && (-1 !== a.inArray(b, [",", "."]) && (b = f.radixPoint), b === f.radixPoint && void 0 !== f.digits && (isNaN(f.digits) || parseInt(f.digits) > 0))) {
                    var g = a.inArray(f.radixPoint, c.buffer), h = (f.numericInput ? c.buffer.slice().reverse() : c.buffer).join("").match(f.regex.integerPart(f));
            ...
            postValidation: function (a, c) {
                var d = !0, e = a.join(""), f = e.replace(c.prefix, "");
                return f = f.replace(c.suffix, ""), f = f.replace(new RegExp(b.escapeRegex(c.groupSeparator), "g"), ""), "," === c.radixPoint && (f = f.replace(b.escapeRegex(c.radixPoint), ".")), f = f.replace(new RegExp("^" + b.escapeRegex(c.negationSymbol.front)), "-"), f = f.replace(new RegExp(b.escapeRegex(c.negationSymbol.back) + "$"), ""), f = f === c.negationSymbol.front ? f + "0" : f, isFinite(f) && (null !== c.max && isFinite(c.max) && (d = parseFloat(f) <= parseFloat(c.max)), d && null !== c.min && isFinite(c.min) && (0 >= f || f.toString().length >= c.min.toString().length) && (d = parseFloat(f) >= parseFloat(c.min), d || (d = {
                    refreshFromBuffer: !0,
            ...
            isComplete: function (a, c) {
                var d = a.join(""), e = d.replace(c.prefix, "");
        ...
        numeric: {
            mask: function (a) {
                ...
                a.placeholder.length > 1 && (a.placeholder = a.placeholder.charAt(0)), a.radixFocus = a.radixFocus && "" !== a.placeholder && a.integerOptional === !0, a.definitions[";"] = a.definitions["~"], a.definitions[";"].definitionSymbol = "~";
                var e = b(a.prefix);
            ...
            postValidation: function (c, d) {
                var e = !0, f = c.join(""), g = f.replace(d.prefix, "");
                        ...
                        function i(b, c) {
                            ...
                            for (var e = 0; e < b.matches.length; e++) {
                                ...
                                if (f.isGroup === !0)d = i(f, !0); else if (f.isQuantifier === !0) {
                                    var g = a.inArray(f, b.matches), h = b.matches[g - 1], j = l;
